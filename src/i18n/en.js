...
export const en = {
  ...
  more: {
    ...
    support: 'Support',
    supportSub: 'Email or call',
    supportMeta: 'Email or call',
    supportEmailBtn: 'Email us',
    supportCallBtn: 'Call us',
    supportAlertBody: 'Email {email} — we usually reply within a day. Or call {phone}.',
    feedback: 'Feedback',
  ...
  editProfile: {
    ...
    photoSourceSub: 'Take a new one or pick a photo you already have.',
    ...
    discardSub: "The edits you've made here haven't been saved yet.",
    discardChanges: 'Discard changes',
    changePhotoA11y: 'Change profile photo',
    clearFieldA11y: 'Clear {field}',
    sectionName: 'Your name',
    sectionContact: 'How dispatch reaches you',
    firstName: 'First name',
